...
function alante_thinkup_toolbox_setup() {    
	...
	*/
	...
	$config = array(
		...
		'tabs'                 => array(
			...
			'documentation'    => __( 'Documentation', 'alante' ),
		...
		'getting_started' => array(
			...
			'second' => array(
				...
				'text'                => sprintf( esc_html__( 'Create a homepage fast. Go to the Customizer -> Theme Options -> Homepage (Featured) to start adding content. Add up to 3 sections fast!', 'alante' ) . '<br /><br />' . esc_html__( 'Fully customize your homepage with %1$s Pro. Add as many sections as you want, change the button text, disable cropping. Plus much more!', 'alante' ), ucfirst( $theme_name ) ),
				'button_label'        => sprintf( esc_html__( 'View %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'         => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'           => false,
				'recommended_actions' => false,
		...
		'documentation'      => array(
			'intro'  => array (
				'section'      => esc_html__( 'Intro', 'alante' ),
				'title'        => esc_html__( 'How to find what you\'re looking for.', 'alante' ),
				'text_main'    => __( '<p>The documentation below will have the same title as the corresponding option in the customizer theme options area.<br />To find what you\'re looking for simply expand the toggle by clicking on it below.</p><p><strong><i>Get Started:</i></strong> You can find all of the theme specific options in the customizer under the Theme Options tab.</p>', 'alante' ),
				'text_side'    => '',
				'hidden'       => true,
			),
			'101'  => array (
				'section'      => esc_html__( 'General Settings', 'alante' ),
				'title'        => esc_html__( 'Page Layout', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>This option can be used to add a sidebar to all pages on your site. To add a sidebar:</p><ul><li>Select a left sidebar or sidebar layout.</li><li>Choose the sidebar you want display for the chosen layout.</li><li>Go to Appearance -&gt; Widgets in your admin area to add widgets to the selected sidebar.</li><li><strong>Note:</strong> If no sidebar is selected then the default "Sidebar" will be used.</li></ul><p>This layout will be applied to all pages published on your website. This will not be applied to the homepage or blog posts. To add a sidebar to the homepage or blog posts go to the relevant section.</p>', 'alante' ),
				'text_side'    => sprintf( __( '<p>Get more with %1$s Pro!</p><ul><li>Create unlimited sidebars.</li><li>Add a different sidebar to different pages.</li><li>Add sidebar layouts to specific pages only.</li><li>Plus much more!</li></ul>', 'alante' ), ucfirst( $theme_name ) ),
			...
			'103'  => array (
				'section'      => esc_html__( 'General Settings', 'alante' ),
				'title'        => esc_html__( 'Enable Breadcrumbs', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>Turn on to display site wide breadcrumbs. These are displayed at the top of each page and show the parent pages of the current page being viewed.</p><p>By default a forward slash (/) will be used to separate pages in the breadcrumb. If you prefer to use a different separator you can specify this using the delimiter input field.</p>', 'alante' ),
				'text_side'    => '',
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => false,
			...
			'201'  => array (
				'section'      => esc_html__( 'Homepage', 'alante' ),
				'title'        => esc_html__( 'Homepage Layout', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>This option can be used to add a sidebar to the homepage on your site. To add a sidebar:</p><ul><li>Select a left sidebar or sidebar layout.</li><li>Choose the sidebar you want display for the chosen layout.</li><li>Go to Appearance -&gt; Widgets in your admin area to add widgets to the selected sidebar.</li><li><strong>Note:</strong> If no sidebar is selected then the default "Sidebar" will be used.</li></ul><p>This layout will be applied only to the homepage on your website. This will not be applied to inner pages or blog posts. To add a sidebar to inner pages or blog posts go to the relevant section.</p>', 'alante' ),
				'text_side'    => sprintf( __( '<p>Get more with %1$s Pro!</p><ul><li>Create unlimited sidebars.</li><li>Add a different sidebar to different pages.</li><li>Add sidebar layouts to specific pages only.</li><li>Plus much more!</li></ul>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
			...
			'203'  => array (
				'section'      => esc_html__( 'Homepage', 'alante' ),
				'title'        => esc_html__( 'Call To Action - Intro', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>Add a call to action message box at the top of content area of the homepage.</p><p>To add the call to action message box do the following:</p><ul><li>Put a tick in the checkbox to enable the message box.</li><li>Add a main message. This will be the header text and wrapped in h3 title tags.</li><li>Add a teaser message to give visitors more information.</li><li>Specify a button message if you want to display a button in the message box.</li><li>Specify whether the button should link to an internal page or external URL.</li><li>If linking to an external URL be sure to add http:// before the URL.</li></ul>', 'alante' ),
				'text_side'    => '',
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => false,
			...
			'204'  => array (
				'section'      => esc_html__( 'Homepage', 'alante' ),
				'title'        => esc_html__( 'Call To Action - Outro', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>Add a call to action message box at the bottom of content area of the homepage.</p><p>To add the call to action message box do the following:</p><ul><li>Put a tick in the checkbox to enable the message box.</li><li>Add a main message. This will be the header text and wrapped in h3 title tags.</li><li>Add a teaser message to give visitors more information.</li><li>Specify a button message if you want to display a button in the message box.</li><li>Specify whether the button should link to an internal page or external URL.</li><li>If linking to an external URL be sure to add http:// before the URL.</li></ul>', 'alante' ),
				'text_side'    => sprintf( __( '<p>Get more with %1$s Pro!</p><p>Add a call to action to every page of your site, not just the homepage.</p><p>Get your visitors attention on every page!</p>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
				'is_new_tab'   => true,
			...
			'303'  => array (
				'section'      => esc_html__( 'Homepage (Featured)', 'alante' ),
				'title'        => __( 'Pre-Made Homepage<span class="hidden">Icon</span>', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				...
				'text_side'    => sprintf( __( '<p>Get more with %1$s Pro!</p><ul><li>Unlimited featured sections.</li><li>Add featured sections to inner pages.</li><li>Change "Read More" button.</li><li>Add a link to any url.</li><li>Plus much more!</li></ul>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
				'is_new_tab'   => true,
			...
			'401'  => array (
				'section'      => esc_html__( 'Header', 'alante' ),
				'title'        => esc_html__( 'Enable Search (Pre Header)', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>Turn this on to add a search box to your website. The search box will display at top of your website.</p>', 'alante' ),
				'text_side'    => '',
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => false,
			...
			'501'  => array (
				'section'      => esc_html__( 'Footer', 'alante' ),
				'title'        => esc_html__( 'Footer Widgets Layout', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>Choose from 18 different footer layouts. Simply select the layout you want and save changes.</p><p>When you have chosen a layout please ensure that widgets are assigned to the footer area. To do this:</p><ul><li>Go to Appearance -> Widgets in your admin area.</li><li>Now simply drag and drop the widgets you want to display into each footer area.</li><li>The footer areas are name "<i>Footer Widget Area 1</i>", "<i>Footer Widget Area 2</i>", etc...</li></ul>', 'alante' ),
				'text_side'    => sprintf( __( '<p>Want your own copyright message?</p><p>That\'s right! With %1$s Pro you can change the footer copyright message in seconds straight from the theme options panel!</p>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
				'is_new_tab'   => true,
			...
			'502'  => array (
				'section'      => esc_html__( 'Footer', 'alante' ),
				'title'        => esc_html__( 'Disable Footer Widgets', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>Turn this on if you want to disable the main footer area entirely.</p>', 'alante' ),
				'text_side'    => sprintf( __( '<p>Want your own copyright message?</p><p>That\'s right! With %1$s Pro you can change the footer copyright message in seconds straight from the theme options panel!</p>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
			...
			'601'  => array (
				'section'      => esc_html__( 'Social Media', 'alante' ),
				'title'        => esc_html__( 'Social Media', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>Links to your favorite social media sites can be added to the header area in seconds. Plus each link comes with a nice tooltip showing the name of the social media site when the link is hovered over.</p><p>To enable social media links:</p><ul><li>First switch on the Enable Social Media Links (footer) button.</li><li>Add a display message if you choose.</li><li><strong>Tip:</strong> This can be used to get your users attention and might be something like "Follow Us".</li></ul><p>There are 7 different social platforms you can choose to show:</p><ul><li>Facebook</li><li>Twitter</li><li>Google+</li><li>LinkedIn</li><li>Flickr</li><li>YouTube</li><li>RSS</li></ul><p>To display a link to any of these you\'ll first need to switch on the button for the social platform you want to activate and then also add a link to your profile page.</p>', 'alante' ),
				'text_side'    => sprintf( __( '<p>Want more?</p><p>With %1$s Pro you can add links to all these profiles in just a few clicks:</p><ul><li>Instagram</li><li>Tumblr</li><li>Pinterest</li><li>Xing</li><li>PayPal</li><li>Vimeo</li><li>Email</li></ul><p>There\'s more! You can even add your own custom social media profiles in seconds!</p>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
				'is_new_tab'   => true,
			...
			'701'  => array (
				'section'      => esc_html__( 'Blog', 'alante' ),
				'title'        => esc_html__( 'Blog Layout', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>This option can be used to add a sidebar to blog archive pages. To add a sidebar:</p><ul><li>Select a left sidebar or sidebar layout.</li><li>Choose the sidebar you want display for the chosen layout.</li><li>Go to Appearance -&gt; Widgets in your admin area to add widgets to the selected sidebar.</li><li><strong>Note:</strong> If no sidebar is selected then the default "Sidebar" will be used.</li></ul><p>This layout will be applied only to blog archive pages. This will not be applied to inner pages or posts. To add a sidebar to inner pages or posts go to the relevant section.</p>', 'alante' ),
				'text_side'    => sprintf( __( '<p>Get more with %1$s Pro!</p><ul><li>Create unlimited sidebars.</li><li>Add a different sidebar to different pages.</li><li>Add sidebar layouts to specific pages only.</li><li>Plus much more!</li></ul>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
			...
			'702'  => array (
				'section'      => esc_html__( 'Blog', 'alante' ),
				'title'        => esc_html__( 'Post Content', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				...
				', 'alante' ),
				'text_side'    => sprintf( __( '<p>Get more with %1$s Pro!</p><ul><li>Create unlimited blog pages.</li><li>Choose your own excerpt length.</li><li>Different layouts for different blogs.</li><li>Plus much more!</li></ul>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
				'is_new_tab'   => true,
			...
			'703'  => array (
				'section'      => esc_html__( 'Blog', 'alante' ),
				'title'        => esc_html__( 'Post Layout', 'alante' ),
				'icon'         => 'dashicons dashicons-sos',
				'text_main'    => __( '<p>This option can be used to add a sidebar to blog posts. To add a sidebar:</p><ul><li>Select a left sidebar or sidebar layout.</li><li>Choose the sidebar you want display for the chosen layout.</li><li>Go to Appearance -&gt; Widgets in your admin area to add widgets to the selected sidebar.</li><li><strong>Note:</strong> If no sidebar is selected then the default "Sidebar" will be used.</li></ul><p>This layout will be applied only to blog posts. This will not be applied to inner pages or blog archive pages. To add a sidebar to inner pages or blog archives to the relevant section.</p>', 'alante' ),
				'text_side'    => sprintf( __( '<p>Get more with %1$s Pro!</p><ul><li>Create unlimited sidebars.</li><li>Add a different sidebar to different pages.</li><li>Add sidebar layouts to specific pages only.</li><li>Plus much more!</li></ul>', 'alante' ), ucfirst( $theme_name ) ),
				'button_label' => sprintf( esc_html__( 'Get %1$s Pro', 'alante' ), ucfirst( $theme_name ) ),
				'button_link'  => esc_url( '//www.thinkupthemes.com/themes/' . $theme_name . '/' ),
				'is_button'    => true,
		...
		'free_pro'                => array(
			...
			'get_pro_theme_label' => sprintf( __( 'Get %s Now!', 'alante' ), ucfirst( $theme_name ) . ' Pro' ),
			'features'            => array(
				array(
	...
	alante_thinkup_toolbox_about_page::init( $config );

}

add_action('after_setup_theme', 'alante_thinkup_toolbox_setup');
