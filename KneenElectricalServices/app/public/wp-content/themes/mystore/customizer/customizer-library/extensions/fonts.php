...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'mystore' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'mystore' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'mystore' ),
		'cyrillic'     => __( 'Cyrillic', 'mystore' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'mystore' ),
		'devanagari'   => __( 'Devanagari', 'mystore' ),
		'greek'        => __( 'Greek', 'mystore' ),
		'greek-ext'    => __( 'Greek Extended', 'mystore' ),
		'khmer'        => __( 'Khmer', 'mystore' ),
		'latin'        => __( 'Latin', 'mystore' ),
		'latin-ext'    => __( 'Latin Extended', 'mystore' ),
		'vietnamese'   => __( 'Vietnamese', 'mystore' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'mystore' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'mystore' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'mystore' ),
