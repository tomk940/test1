...
function doPreviewDecoration(root, $) {
    ...
    root.CP_Customizer.on(root.CP_Customizer.events.ELEMENT_DECORATED, function (event, $element) {
        ...
        // $element.find('[data-hover-fx]').delay(500).find('.overlay').css({
        //     display: 'block',
        //     opacity: 0.75
        // });
        // $element.find('[data-hover-fx]').delay(500).find('.swap-inner').css({
        //     display: 'block',
        //     opacity: 1
        // });
        //
        // if ($element.is('[data-hover-fx]')) {
        //     $element.delay(500).find('.overlay').css({
        //         display: 'block',
        //         opacity: 0.75
        //     });
        //     $element.delay(500).find('.swap-inner').css({
        //         display: 'block',
        //         opacity: 1
        //     });
        // }
